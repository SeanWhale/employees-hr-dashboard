...
def run_etl():
    ...
    for filename in DUMP_FILES:
        ...
        # --- 6c. 合并相邻的同部门记录 ---
        # 场景：员工 A 在 2020-01-01 ~ 2020-06-30 在技术部，
        #      紧接着 2020-07-01 ~ 2020-12-31 也在技术部（中间没有换部门）
        #      这种情况可以合并成 2020-01-01 ~ 2020-12-31 一条记录
        ...
        # --- 6d. 修复时间区间重叠 ---
        # 场景：员工 A 有两条职称记录：
        #       2020-01-01 ~ 2020-12-31: 初级工程师
        #       2020-06-01 ~ 2021-06-30: 中级工程师
